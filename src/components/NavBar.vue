...
<template>
  <header class="w-full md:h-[96vh] md:w-1/4 lg:w-1/5 xl:w-1/6 fixed md:top-4 bottom-0 md:p-4 z-50">
    <div
      class="w-full md:h-full p-2 md:p-4 flex flex-col absolute bottom-0 backdrop-blur-sm bg-gray-200/70 dark:bg-gray-800/70 rounded-t-2xl shadow-xl shadow-gray-400/30 md:rounded-lg transition-all duration-300 ease-in-out"
      :class="{ 'h-16 md:w-32': !isOpen, 'h-auto md:w-56': isOpen }">
      ...
      <div class="md:hidden flex justify-between items-center mb-2">
        ...
        <button @click="toggleMenu"
          class="w-12 h-12 p-2 flex justify-center items-center hover:bg-gray-700 hover:dark:bg-white/80 hover:text-gray-200 text-gray-700 dark:text-white/80 hover:dark:text-gray-700 rounded-full transition duration-300 ease-in-out">
      ...
      <div class="hidden md:flex mb-4 justify-between items-center">
        ...
        <img src="../assets/avatar.jpg" alt="Avatar" class="w-12 h-12 object-cover rounded-full transition duration-300 ease-in-out" :class="{ 'flex': !isOpen, 'hidden': isOpen }">
        <button @click="toggleMenu"
          class="w-8 h-8 p-2 flex justify-center items-center hover:bg-gray-700 hover:dark:bg-white/80 hover:text-gray-200 text-gray-700 dark:text-white/80 hover:dark:text-gray-700 rounded-full transition duration-300 ease-in-out">
      ...
      <div class="overflow-hidden transition-all duration-300 ease-in-out"
        ...
        <nav class="grid grid-cols-7 md:grid-cols-1 gap-2 text-center md:mt-4">
          <RouterLink to="/"
            ...
            <i
              class="fa-solid fa-house text-green-800 dark:text-green-500 text-base md:text-3xl lg:text-4xl xl:text-5xl"></i>
          ...
          <RouterLink to="/about"
            class="h-14 md:h-20 bg-green-400/50 hover:bg-green-600/50 dark:bg-gray-900 dark:hover:bg-gray-700 dark:text-white/80 font-medium rounded-xl flex flex-col md:flex-row items-center justify-center transition"
            :class="{ 'md:justify-start md:px-4': isOpen, 'md:justify-center': !isOpen }">
            <i class="fa-solid fa-user text-base md:text-3xl lg:text-4xl xl:text-5xl"></i>
          ...
          <RouterLink to="/skill"
            class="h-14 md:h-20 bg-green-400/50 hover:bg-green-600/50 dark:bg-gray-900 dark:hover:bg-gray-700 dark:text-white/80 font-medium rounded-xl flex flex-col md:flex-row items-center justify-center transition"
            :class="{ 'md:justify-start md:px-4': isOpen, 'md:justify-center': !isOpen }">
            <i class="fa-solid fa-pen-nib text-base md:text-3xl lg:text-4xl xl:text-5xl"></i>
            <span class="text-[7px] md:text-base lg:text-md xl:text-lg md:ml-2 transition-all duration-300"
          ...
          <RouterLink to="/project"
            class="h-14 md:h-20 bg-green-400/50 hover:bg-green-600/50 dark:bg-gray-900 dark:hover:bg-gray-700 dark:text-white/80 font-medium rounded-xl flex flex-col md:flex-row items-center justify-center transition"
            :class="{ 'md:justify-start md:px-4': isOpen, 'md:justify-center': !isOpen }">
            <i class="fa-solid fa-list-check text-base md:text-3xl lg:text-4xl xl:text-5xl"></i>
            <span class="text-[7px] md:text-base lg:text-md xl:text-lg md:ml-2 transition-all duration-300"
          ...
          <RouterLink to="/contact"
            class="h-14 md:h-20 bg-green-400/50 hover:bg-green-600/50 dark:bg-gray-900 dark:hover:bg-gray-700 dark:text-white/80 font-medium rounded-xl flex flex-col md:flex-row items-center justify-center transition"
            :class="{ 'md:justify-start md:px-4': isOpen, 'md:justify-center': !isOpen }">
            <i class="fa-solid fa-envelope text-base md:text-3xl lg:text-4xl xl:text-5xl"></i>
            <span class="text-[7px] md:text-base lg:text-md xl:text-lg md:ml-2 transition-all duration-300"
          ...
          <div class="md:hidden h-14 md:h-20 relative group">
            ...
            <div
              class="fixed right-14 -top-8 md:top-20 md:left-0 w-24 bg-white dark:bg-gray-800 dark:text-gray-200 rounded-lg overflow-hidden shadow-lg py-0 z-10 invisible group-hover:visible opacity-0 group-hover:opacity-100 transition">
              <a href="?lang=en"
        ...
        <div class="grid grid-rows-2 gap-2 md:mt-4">
          ...
          <div class="hidden md:flex relative group">
            ...
            <div
              class="absolute right-0 top-2 w-24 bg-white dark:bg-gray-800 dark:text-gray-200 rounded-lg overflow-hidden shadow-lg py-0 z-10 invisible group-hover:visible opacity-0 group-hover:opacity-100 transition">
              <a href="?lang=en"
                class="block w-full text-left px-4 py-1 dark:hover:bg-gray-700 hover:bg-gray-200">English</a>
              <a href="?lang=kh"
                class="block w-full text-left px-4 py-1 dark:hover:bg-gray-700 hover:bg-gray-200">ខ្មែរ</a>
